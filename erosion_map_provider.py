...
from .erosion_map_algorithm import ErosionMapAlgorithm


class ErosionMapProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(ErosionMapAlgorithm())
