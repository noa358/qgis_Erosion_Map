...
class ErosionMapAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'OUTPUT_GROUND': '{0}\\temp1.tif'.format(parameters['data_export_destination']),
            'RADIUS': 2,
            'STANDARD_DEVIATION': 0.9,
            'TERRAIN_SLOPE': 50,
            'OUTPUT_NONGROUND': 'TEMPORARY_OUTPUT',
        }
        ...
        # Load layer into project
        alg_params = {
            'INPUT': '{0}\\temp1.tif'.format(parameters['data_export_destination']),
